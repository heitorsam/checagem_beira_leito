...
GROUP BY
 ...
 $consulta_pac = "SELECT lt_set.CD_SETOR, lt_set.NM_SETOR,
            ...
            echo '<div 
                ...
                color: #ffffff; background-color: #6996EF !important;">';
                    ...
                    echo '<div class="row justify-content-md-center" style="padding: 1px 1em 0 1em; border-radius: 3px !important;">';
                        ...
                        echo '<div onclick="mostrar_pac_'. $id_paciente .'('.$row_pac['CD_ATENDIMENTO'].',' . $row_pac['CD_PACIENTE'].','.$var_frm_setor .
