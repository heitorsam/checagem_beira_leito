...
<body style="padding: 21px";>
    ...
    <form method="POST" action="formulario.php">
        ...
        <br>Nome:<br>
        <input type="text" class="form-control"  style="width: 30%;" name="frm_nome" minlength="5" required>

        <br>Idade:<br>
        <input type="number" class="form-control" style="width: 30%;" name="frm_idade" required>

        <br>Sexo:<br>
        <select name="frm_sexo" class="form-control" style="width: 30%;" required>
            <option value="M">Masculino</option>
            <option valur="F">Feminino</option>
        </select>
